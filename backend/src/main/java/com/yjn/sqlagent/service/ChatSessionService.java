...
public interface ChatSessionService {
    ...
    default void touch(String obId, String sessionId, String message) {
        touch(obId, sessionId, message, null);
    }

    /** 首次创建时记录页面来源；后续同会话不得切换到其他实体。 */
    void touch(String obId, String sessionId, String message, AiContextDTO context);
