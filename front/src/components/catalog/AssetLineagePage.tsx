...
export default function AssetLineagePage() {
  ...
  return <div className="asset-lineage-page"><header><div><Typography.Title level={2}>全局血缘</Typography.Title><Typography.Text type="secondary">基于生效离线版本与最新实时版本，统一查看 Hive、Paimon、MySQL 和任务关系。</Typography.Text></div><Button icon={<ReloadOutlined />} onClick={() => void search()}>刷新</Button></header>
