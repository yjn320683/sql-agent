...
public class SqlBaseLexer extends Lexer {
	...
	public static final int
		...
		BRACKETED_COMMENT=215, WS=216, QUESTION_MARK=217, UNRECOGNIZED=218;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VALUES", "CREATE", "TABLE", "VIEW", "REPLACE", "INSERT", "OVERWRITE", 
			...
			"QUAD_QUOTE_STRING", "TRIPLE_QUOTE_STRING", "STRING", "INTEGER_VALUE", 
