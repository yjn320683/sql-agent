...
class Neo4jHttpGraphStoreClientTest {
    @Test
    void readsOfficialQueryApiPlainJsonShape() {
        ...
        server.expect(requestTo("http://neo4j:7474/db/lineage/query/v2"))
                .andExpect(header(HttpHeaders.AUTHORIZATION,"Basic bmVvNGo6c2VjcmV0"))
                .andRespond(withSuccess("{\"data\":{\"fields\":[\"name\",\"count\"],\"values\":[[\"orders\",2]]}}", MediaType.APPLICATION_JSON));
